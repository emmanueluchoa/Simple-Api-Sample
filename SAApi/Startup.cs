...
using SAData.MongoDb;
using SADomain.Application;
...
namespace SAApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IMongoDbConfig>(config => config.GetRequiredService<IOptions<MongoDbConfig>>().Value);
            services.AddScoped<IPessoaRepository, PessoaMongoRepository>();
